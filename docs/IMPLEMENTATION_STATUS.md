...
## Modales documentales y lectura de Mercado (2026-09-21)

- **Casa** ya no duplica seguros: mantiene únicamente “Seguros relacionados con la vivienda”. El acceso redundante “Seguros y protección” se elimina también de la navegación contextual de Patrimonio; la ficha completa de seguros sigue accesible desde las pólizas relacionadas.
- **Hipoteca** se presenta como ficha de lectura. Los datos principales (valor de vivienda, capital pendiente, cuota, tipo/TIN, TAE, vencimiento, equity y LTV) se ven sin entrar en edición. “Datos de la hipoteca” abre un modal para actualizar datos principales, valoración y condiciones/calendario. Se elimina el antiguo módulo inline “Valor de la vivienda y datos para comparar”.
- **Documentación contextual**: hipotecas y pólizas usan un modal reutilizable que permite listar documentos asociados, añadir archivos, abrir el documento original y consultar/actualizar resúmenes de IA local sin abandonar la pantalla.
- **Seguros y coberturas**: “Pólizas consolidadas” ocupa todo el ancho. Se elimina “Qué requiere atención” y el bloque separado de “Relaciones con hipoteca u otros productos”. La lectura documental se agrupa por póliza y se resume en qué cubre, ventajas, penalizaciones y límites/exclusiones, con acceso a la página de evidencia cuando existe.
- **Editar seguro** funciona dentro del propio detalle de la póliza y guarda sin cerrar la ficha.
