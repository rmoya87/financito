...
type Policy={
  ...
  source_document_id:string|null;source_document_name:string|null;source_document_ids?:string[];
  source_documents?:{id:string;file_name:string}[];document_count?:number;
