...
export default function TaxPage(){
  ...
  const estimateReady=!!estimate.data?.known_information&&!!estimate.data?.calculation;
  ...
  return <>
    ...
    <Card className="mt-4">
      ...
      {estimate.data&&estimateReady?<div className="mt-4 space-y-4">
