...
NORMALIZED_FIELDS=["Fecha","Concepto","Importe","Moneda","Comercio","Estado"]
    ...
    for line in text.splitlines():
        if line.startswith(":61:"):
            ...
            if m:
                ...
                current={"Fecha":dt,"Importe":amount,"Concepto":"Movimiento","Comercio":"","Moneda":"EUR"};rows.append(current)
