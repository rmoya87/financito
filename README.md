...
- [Modelo temporal](docs/TEMPORAL_MODEL.md)
- [Lotes de inversión y fiscalidad](docs/INVESTMENT_LOTS_AND_TAX.md)
- [Action Center](docs/ACTION_CENTER.md)
- [Runtime local y launcher](docs/LOCAL_RUNTIME_AND_LAUNCHER.md)
